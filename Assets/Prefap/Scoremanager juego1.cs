...
public class Scoremanagerjuego1 : MonoBehaviour
{
    public static Scoremanagerjuego1 instance;
    public TextMeshProUGUI scoreText;
    private int totalScore = 0;
    // URL base de tu servidor PHP
    private string baseUrl = "http://localhost/";
    private int userId = 13; // ID del usuario, debe ser dinámico
    ...
    public static Scoremanagerjuego1 Instance
    {
        get
        {
            if (instance == null)
            {
                instance = FindObjectOfType<Scoremanagerjuego1>();
            }
            return instance;
        }
    }
